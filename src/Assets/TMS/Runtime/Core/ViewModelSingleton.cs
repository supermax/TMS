namespace TMS.Common.Core
{
		...
		where T : ViewModel, new()
	{
		...
		protected static readonly new Tuple<T> Locker = new Tuple<T>();
		...
		where TImplementation : ViewModel, TInterface, new()
	{
		...
		protected static bool _isInitializing;
		protected static readonly new Tuple<TInterface, TImplementation> Locker = new Tuple<TInterface, TImplementation>();
