...
namespace TMS.Common.Core
{
	...
	public class DelegateCommandInspector : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			Target.CommandTarget = (GameObject)EditorGUILayout.ObjectField(Target.CommandTarget, typeof(GameObject), true);
			...
			if (Target.CommandParameter2.IsNullOrEmpty())
			{
				...
				Target.CommandParameter1 = EditorGUILayout.ObjectField(Target.CommandParameter1, typeof(Object), true, GUILayout.Width(120));
			}
