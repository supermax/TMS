...
namespace TMS.Common.Extensions
{
	...
	public static class ArgumentValidator
	{
		...
		/// <summary>
		/// Asserts the "sorce" not equals to given "value".
		/// </summary>
		...
		/// <returns>Asserted source</returns>
		/// <exception cref="ArgumentNullException"></exception>
		public static T AssertNotEquals<T>(T source, T value, string parameterName, string message, params object[] args)
		{
			if (Equals(source, value))
			{
				throw new ArgumentNullException(string.Format(message, args), parameterName);
			}
			return source;
		}
	}
