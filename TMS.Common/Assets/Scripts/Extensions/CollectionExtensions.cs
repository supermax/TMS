...
namespace TMS.Common.Extensions
{
	...
	public static class CollectionExtensions
	{
		...
		public static bool Equals<T>(this T[] a1, T[] a2, int index, int count)
		{
		...
		public static T[] Combine<T>(this IEnumerable<T[]> src)
		{
			var lst = new List<T>();
		...
		public static T[] Take<T>(this T[] array, int index, int count)
		{
