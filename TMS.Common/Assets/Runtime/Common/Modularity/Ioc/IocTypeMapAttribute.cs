...
namespace TMS.Common.Modularity.Ioc
{
	...
	public class IocTypeMapAttribute : Attribute
	{
		...
		/// <summary>
		/// Gets or sets the dependencies. Init order logic will based on type dependecies.
		/// </summary>
		/// <value>
		/// The dependencies.
		/// </value>
		...
		public virtual void OnInstantiation(object instance)
		{
		}
		...
		public virtual void OnRegistration(Type ownerType)
		{
		}
	}
}