...
namespace TMS.Common.Helpers
{
	...
	public class DataMapper : Singleton<DataMapper>
	{
		...
		/// <returns></returns>
		public object CopyPropertyValues(IDictionary<string, object> values, object target, params string[] ignoreProps)
		{
		...
		/// <param name="ignoreProps">The ignore props.</param>
		/// <returns></returns>
		/// <exception cref="OperationCanceledException">The source and the target are the same instance!</exception>
		/// <exception cref="System.OperationCanceledException">The source and the target are the same instance!</exception>
		public object CopyPropertyValues(object source, object target, params string[] ignoreProps)
		{
		...
		/// <exception cref="OperationCanceledException">The source and the target are the same instance!</exception>
		/// <exception cref="System.OperationCanceledException">The source and the target are the same instance!</exception>
		public T CopyPropertyValues<T>(T source, T target, params string[] ignoreProps)
		{
			if (ReferenceEquals(source, target))
			{
				throw new OperationCanceledException("The source and the target are the same instance!");
		...
		/// <exception cref="OperationCanceledException">The source and the target are the same instance!</exception>
		/// <exception cref="System.OperationCanceledException">The source and the target are the same instance!</exception>
		public object CopyPropertyValues(Type sourceType, object target, params string[] ignoreProps)
		{
