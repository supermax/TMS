...
namespace TMS.Common.Tasks.Threading
{
	...
	public abstract class CustomThread : IDisposable
	{
		private static CustomThread _currentThread;
		...
		///     The thread.
		/// </value>
		protected virtual Task Thread { get; set; }
		...
		public bool IsAlive
		{
			get { return Thread != null && Thread.Status == TaskStatus.Running; }
		}
		...
		public void Start()
		{
			...
			Thread = Task.Factory.StartNew(DoInternal, _cancellationToken);
		...
		public void Abort()
		{
			...
			_cancellationToken.WaitHandle.Dispose();
			// TODO check how to abort task on UWP
		}
