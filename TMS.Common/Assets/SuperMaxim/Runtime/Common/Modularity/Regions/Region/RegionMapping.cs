...
namespace TMS.Common.Modularity.Regions
{
	...
	{
		private static readonly Core.Tuple<RegionViewMappingType, Action<RegionViewMappingPayload>>
			RegionViewMappingActionsLocker = new Core.Tuple<RegionViewMappingType, Action<RegionViewMappingPayload>>();
